		...
		<div className="w-full h-screen grid grid-cols-2">
			...
			<div className="h-screen bg-gradient flex justify-center items-start text-left flex-col text-white">
				<div className="mx-16 space-y-8">
					<h1 className="font-poppins text-5xl font-bold w-11/12">Creative work shows <br />us what’s possible. <br />Help fund it here.</h1>
					<p className="font-poppins text-md font-light w-3/4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
