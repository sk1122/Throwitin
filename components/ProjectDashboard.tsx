...
const ProjectDashboard: FC = () => {
	return (
		<div className="w-full h-full bg-brand-lightdark text-white">
			<div className="w-full h-full">
				<table className="table-auto w-full border border-1">
							<thead className="text-md font-semibold uppercase bg-brand-dark">
								<tr>
									...
									<th className="p-4 whitespace-nowrap">
										<div className="font-semibold text-center">Amount Invested</div>
									</th>
								</tr>
							</thead>
							<tbody className="text-md bg-transparent">
